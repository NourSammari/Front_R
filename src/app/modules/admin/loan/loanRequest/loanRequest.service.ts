...
import { Mail, MailCategory, MailFilter, MailFolder, MailLabel } from 'app/modules/admin/loan/loanRequest/loanRequest.types';
...
export class MailboxService
{
    ...
    {
        return this._httpClient.get<MailFolder[]>('api/apps/LoanRequest/folders').pipe(
            tap((response: any) =>
            {
    ...
    {
        return this._httpClient.get<MailLabel[]>('api/apps/LoanRequest/labels').pipe(
            tap((response: any) =>
            {
    ...
    getMailsByFilter(filter: string, page: string = '1'): Observable<any>
    {
        ...
        return this._httpClient.get<Mail[]>('api/apps/LoanRequest/mails', {
            params: {
                filter,
                page,
            },
    ...
    {
        return this._httpClient.patch('api/apps/LoanRequest/mail', {
            id,
            mail,
        }).pipe(
            tap(() =>
    ...
    addLabel(label: MailLabel): Observable<any>
    {
        return this.labels$.pipe(
            take(1),
            switchMap(labels => this._httpClient.post<MailLabel>('api/apps/LoanRequest/label', {label}).pipe(
                map((newLabel) =>
                {
    ...
    updateLabel(id: string, label: MailLabel): Observable<any>
    {
        return this.labels$.pipe(
            take(1),
            switchMap(labels => this._httpClient.patch<MailLabel>('api/apps/LoanRequest/label', {
                id,
                label,
            }).pipe(
    ...
    deleteLabel(id: string): Observable<any>
    {
        return this.labels$.pipe(
            take(1),
            switchMap(labels => this._httpClient.delete('api/apps/LoanRequest/label', {params: {id}}).pipe(
                map((isDeleted: any) =>
                {
