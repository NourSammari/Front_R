...
import { filters as filtersData, folders as foldersData, labels as labelsData, mails as mailsData } from 'app/mock-api/apps/advanceSalary/data';
...
export class advanceSalaryMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            .onGet('api/apps/advanceSalary/folders')
            .reply(() =>
            {
                let count = 0;
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/advanceSalary/filters')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/advanceSalary/labels')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/apps/advanceSalary/label')
            .reply(({request}) =>
            {
                // Get the label
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/advanceSalary/label')
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/apps/advanceSalary/label')
            .reply(({request}) =>
            {
                // Get the id
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/advanceSalary/mails', 625)
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/advanceSalary/mail')
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/advanceSalary/mail')
            .reply(({request}) =>
            {
                // Get the id and mail
                const id = request.body.id;
