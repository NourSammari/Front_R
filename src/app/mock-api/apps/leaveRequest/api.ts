...
import { filters as filtersData, folders as foldersData, labels as labelsData, mails as mailsData } from 'app/mock-api/apps/leaveRequest/data';
...
export class leaveRequest
{
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            .onGet('api/apps/leaveRequest/folders')
            .reply(() =>
            {
                let count = 0;
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/leaveRequest/filters')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/leaveRequest/labels')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/apps/leaveRequest/label')
            .reply(({request}) =>
            {
                // Get the label
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/leaveRequest/label')
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/apps/leaveRequest/label')
            .reply(({request}) =>
            {
                // Get the id
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/leaveRequest/mails', 625)
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/leaveRequest/mail')
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/leaveRequest/mail')
            .reply(({request}) =>
            {
                // Get the id and mail
                const id = request.body.id;
