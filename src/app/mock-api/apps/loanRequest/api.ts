...
import { filters as filtersData, folders as foldersData, labels as labelsData, mails as mailsData } from 'app/mock-api/apps/loanRequest/data';
...
export class LoanRequest
{
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            .onGet('api/apps/LoanRequest/folders')
            .reply(() =>
            {
                let count = 0;
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/LoanRequest/filters')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/LoanRequest/labels')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/apps/LoanRequest/label')
            .reply(({request}) =>
            {
                // Get the label
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/LoanRequest/label')
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/apps/LoanRequest/label')
            .reply(({request}) =>
            {
                // Get the id
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/LoanRequest/mails', 625)
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/LoanRequest/mail')
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/LoanRequest/mail')
            .reply(({request}) =>
            {
                // Get the id and mail
                const id = request.body.id;
