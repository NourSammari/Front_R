...
import { filters as filtersData, folders as foldersData, labels as labelsData, mails as mailsData } from 'app/mock-api/apps/exitPermission/data';
...
export class exitPermission
{
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            .onGet('api/apps/exitPermission/folders')
            .reply(() =>
            {
                let count = 0;
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/exitPermission/filters')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/exitPermission/labels')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/apps/exitPermission/label')
            .reply(({request}) =>
            {
                // Get the label
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/exitPermission/label')
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/apps/exitPermission/label')
            .reply(({request}) =>
            {
                // Get the id
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/exitPermission/mails', 625)
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/exitPermission/mail')
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/exitPermission/mail')
            .reply(({request}) =>
            {
                // Get the id and mail
                const id = request.body.id;
